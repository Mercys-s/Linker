...
class SubjectItem (models.Model):
    ...
    docx_file = models.FileField (verbose_name = 'Docx Файл' , blank = False , null = True , upload_to = 'workflow/static/workflow/documents/')
    pdf_file = models.FileField (verbose_name = 'PDF Файл' , blank = True , null = True )   
    video = models.FileField (blank = True , verbose_name = 'Видео')
    author = models.CharField (max_length = 30 , blank = False , verbose_name = 'Имя Автора')
    ...
    category = models.ForeignKey ('SubjectCategory' , on_delete = models.PROTECT , null = True , blank = False , verbose_name = 'Предмет')
