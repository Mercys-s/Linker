...
ALLOWED_HOSTS = ['Dehomeee.pythonanywhere.com','localhost']

SECRET_KEY = 'django-insecure-_0j5=&yc^sjlf1feuhfuyegf&%Rdhbm4b@dn7+6z2@yte&!x8t9!7g'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'rest_framework.renderers.BrowsableAPIRenderer', #Удалить для прода
    ],
